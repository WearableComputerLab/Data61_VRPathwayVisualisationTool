...
public class NodeSelector : PokeSelector
{
    ...
    private void Update()
    {
        ...
        //if ((!nodeChild && showNodeChildOnStart))
        //{
    ...
    private void OnTriggerEnter(Collider collision)
    {
        ...
        //        //var currentNode = this.transform.gameObject.GetComponent<Grabbable>();
        ...
        //        Debug.Log("Exited: " + exited + " Child Active: " + childActive +  " Node Child: " + nodeChild);
        ...
        if (collision.gameObject.name == "Cone")
        {
            ...
            foreach (var child in heads) 
            {
                if (child.GetComponent<PhotonView>().Owner == collision.gameObject.GetComponentInParent<PhotonView>().Owner)
                {
                    head = child.transform;
                }
            }
